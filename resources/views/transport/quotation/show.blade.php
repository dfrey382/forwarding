                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-9">
                                                                                        <input type="text" value="{{$quotation->customer->Name}}" required id="name" name="name" class="form-control"
...
{{--                                            <a href="{{ url('/quotation/customer/declined/'.$quotation->id) }}" onclick="cssLoader()" class="btn btn-danger" type="submit"> Declined </a>--}}
            ...
            @elseif($quotation->status == \Esl\helpers\Constants::LEAD_QUOTATION_REQUEST)
                <div class="card card-body">
