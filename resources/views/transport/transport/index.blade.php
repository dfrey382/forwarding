                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        @foreach($quotations as $quotation)
                                            @if($quotation->status == 'converted' || $quotation->status == 'requested' || $quotation->status == 'checked' )
                                                <tr>
                                                    <td>QU00{{ $quotation->id.'/'.\Carbon\Carbon::parse($quotation->created_at)->format('y') }}</td>
