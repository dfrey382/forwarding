                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="job_type" required id="job_type"
                                                                ...
                                                                <option value="RLI">Rail Import</option>
                                                                <option value="RI">Road Import</option>
                                                                @else
                                                                <option value="AE">Air Export</option>
                                                                <option value="SE">Sea Export</option>
                                                                <option value="RLE">Rail Export</option>
                                                                <option value="RE">Road Export</option>
                                                                @endif
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="branch">Branch Short Code</label>
                                                            <input type="text" required id="branch" name="branch" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" required id="vessel" name="vessel" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="client_notification" required id="client_notification"
                                                                ...
                                                                <option value="dont">Don't notify customer</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        ...
                                        {{--'open' ? 'Open' : 'Rates') : ($dms->contracts->contract_type == 'per_km' ?--}}
                                         {{--'Per Kilo Meter' : 'Per Tonne') }}</td>--}}
                                                        ...
                                                        {{--<td>{{ number_format($dms->transports->sum('buying'))}} USD</td>--}}
                                                        {{--<td>{{ number_format($dms->transports->sum('cost'))}} USD</td>--}}
                                                            {{--@endif--}}
                                                    {{--</tr>--}}
                                                    {{--</tbody>--}}
                                                {{--</table>--}}
...
{{--                                                            <td>{{ (\Carbon\Carbon::parse($transport->depart)->subDays(\Carbon\Carbon::parse($transport->return)->format('d-M-y H:m:s'))) }}</td>--}}
                                        ...
                                        {{--</div>--}}
                                         {{--<div class="tab-pane p-20" id="agency" role="tabpanel">--}}
                                            ...
                                            {{--<div class="row">--}}
                                                {{--<div class="col-sm-3">--}}
                                                    {{--<button class="btn btn-success">Delivery Order</button>--}}
                                                {{--</div>--}}
                                                {{--<div class="col-sm-3">--}}
                                                    {{--<button class="btn btn-success">Download DSR</button>--}}
                                                {{--</div>--}}
                                                {{--<div class="col-sm-3">--}}
