...
{
    protected  $fillable = ['code_name','file_number','contract_ids','client_notification',
        'quote_id','start','destination','Client_id','cargo_weight','desc','remarks','destination_country',
        'ctm_ref','shipper','shipping_line','seal_number','status','distance','bl_number','stage'];
